...
tgas = config.gas
bsc = "https://speedy-nodes-nyc.moralis.io/b6905c301ad6187a708272d7/polygon/mainnet"
...
panRouterContractAddress = web3.toChecksumAddress('0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff')
...
factoryaddr = web3.toChecksumAddress('0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32')
...
wbnb_addr = web3.toChecksumAddress("0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270")
busd_addr = web3.toChecksumAddress("0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174")
...
bbb = input("1 for wmatic...............2 for usdc...............")
    ...
    if bbb == '1':
        while True :
            ...
            if (wbnb_lp != web3.toChecksumAddress("0x0000000000000000000000000000000000000000")):
                ...
                print(wbnb_bal)
                if wbnb_bal > 5000000000000000000 and wbnb_bal < 10000000000000000000000 :
                    print("WMATIC Liquidity is FOUND!!!\n")
                    break
                print("Liquidity NOT ADDED, AWAITING matic LIQUIDITY!!!")
        ...
        while True:
            ...
            if (busd_lp != web3.toChecksumAddress("0x0000000000000000000000000000000000000000")): 
                ...
                if busd_bal >= 50000000000000000000 :
                    print("USDC Liquidity is FOUND!!!\n")
                    break
                print("Liquidity NOT ADDED, AWAITING usdc LIQUIDITY!!!")
            print("Pair Contract not found. Awaiting......")
