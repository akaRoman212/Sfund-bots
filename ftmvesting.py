...
bsc = "https://rpc.ftm.tools"
web3 = Web3(Web3.HTTPProvider(bsc))

print(web3.isConnected())

panRouterContractAddress = '0xF491e7B69E4244ad4002BC14e878a34207E38c29'
...
bnb_addr = web3.toChecksumAddress("0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83")

#BUSD address for busd pool
busd_addr = web3.toChecksumAddress("0x04068DA6C83AFCFA0e13ba15A6696662335D5B75")
...
while (zeroOne != '0'):
    ...
    print(f"Swapping {readable} {symbol} ")
